...
public abstract class Command
    ...
    public static void sendRemovableMessage(String message, int id) {
        if (mc.player != null && mc.world != null) {
            mc.ingameGUI.getChatGUI().printChatMessageWithOptionalDeletion(new TextComponentString(OyVey.commandManager.getClientMessage() + " " + ChatFormatting.GRAY + message), id);
        }
    }
