...
public class AltButton {
    ...
    public void drawScreen(final int mouseX, final int mouseY) {
        ...
        GrassWare.textManager.renderString(email, x + 5.0f, y + 5.0f, Color.WHITE);
        final StringBuilder string = new StringBuilder();
        for (int i = 0; i < password.length(); i++) {
            string.append("*");
        }
        GrassWare.textManager.renderString(string.toString(), x + 5.0f, y + 17.5f, Color.WHITE);

        RenderUtil.rect(x + 5.0f, y + height - 17.5f, x + width / 2.0f - 5.0f, y + height - 2.5f, new Color(15, 15, 15));
        GrassWare.textManager.renderString("Login", x + 2.5f + ((width / 2.0f - 5.0f) / 2.0f) - GrassWare.textManager.stringWidth("Login") / 2.0f, y + height - 7.5f - GrassWare.textManager.stringHeight() / 2.0f, Color.WHITE);
        ...
        GrassWare.textManager.renderString("Delete", x + width / 2.0f + 2.5f + ((width / 2.0f - 5.0f) / 2.0f) - GrassWare.textManager.stringWidth("Delete") / 2.0f, y + height - 7.5f - GrassWare.textManager.stringHeight() / 2.0f, Color.RED);
    }
